...
func CORSMiddleware() gin.HandlerFunc {
	return cors.New(cors.Config{
		...
		AllowHeaders:     []string{"Origin", "Content-Length", "Content-Type", "Authorization", "aaa-auth-token", "X-Requested-With", "Accept", "Accept-Encoding", "Accept-Language", "Cache-Control", "Connection", "DNT", "Host", "Pragma", "Referer", "User-Agent"},

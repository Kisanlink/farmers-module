...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.DetectFarmOverlapsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.RebuildSpatialIndexesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.ReconcileAAALinksResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.ValidateGeometryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.SimpleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.IrrigationSourcesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.SoilTypesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "internal_handlers.DetectFarmOverlapsResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_handlers.IrrigationSourcesResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_handlers.RebuildSpatialIndexesResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_handlers.ReconcileAAALinksResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_handlers.SimpleResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "internal_handlers.SoilTypesResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_handlers.ValidateGeometryResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {

...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/seed/lookups": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Seed lookups request parameters",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_requests.SeedLookupsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_responses.SwaggerSeedLookupsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/identity/farmer/linkage/{farmer_id}/{org_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/identity/fpo/org/{aaa_org_id}/ceo": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update CEO Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_requests.UpdateCEORequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_responses.UpdateCEOResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "409": {
                        "description": "User is already CEO of another FPO",
                        "schema": {
                            "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_responses.SwaggerErrorResponse"
                        }
                    },
        ...
        "/identity/fpo/reference/{aaa_org_id}": {
            "get": {
    ...
    "definitions": {
        ...
        "github_com_Kisanlink_farmers-module_internal_entities_requests.SeedLookupsRequest": {
            "type": "object",
            "properties": {
                "force": {
                ...
                "seed_irrigation_sources": {
                    "description": "Seed irrigation sources",
                    "type": "boolean",
                    "example": true
                },
                "seed_soil_types": {
                    "description": "Seed soil types",
                    "type": "boolean",
                    "example": true
                },
                "timestamp": {
        ...
        "github_com_Kisanlink_farmers-module_internal_entities_requests.UpdateCEORequest": {
            "type": "object",
            "required": [
                "new_ceo_user_id"
            ],
        ...
        "github_com_Kisanlink_farmers-module_internal_entities_responses.SwaggerSeedLookupsResponse": {
            "type": "object",
            "properties": {
                "details": {
                    "type": "object",
                ...
                "message": {
                    "type": "string",
                    "example": "Successfully seeded lookup data: 6 soil types, 6 irrigation sources"
                },
                "success": {
                    "type": "boolean",
                    "example": true
        ...
        "github_com_Kisanlink_farmers-module_internal_entities_responses.UpdateCEOData": {
            "type": "object",
            "properties": {
                "aaa_org_id": {
                    "type": "string"
        ...
        "github_com_Kisanlink_farmers-module_internal_entities_responses.UpdateCEOResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_Kisanlink_farmers-module_internal_entities_responses.UpdateCEOData"
                },
                "error": {},
                "message": {
                    "type": "string"

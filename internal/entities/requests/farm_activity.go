...
type CreateActivityRequest struct {
	...
	Metadata     map[string]string `json:"metadata" example:"seed_type:HD2967,seed_rate:100kg_per_acre"`
}
...
type CompleteActivityRequest struct {
	...
	Output      map[string]string `json:"output" example:"area_covered:2.5ha,workers:4,notes:completed_successfully"`
}
...
type UpdateActivityRequest struct {
	...
	Metadata     map[string]string `json:"metadata,omitempty" example:"water_source:borewell,duration:2hours"`
}

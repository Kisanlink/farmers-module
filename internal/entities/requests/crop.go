...
type CreateCropRequest struct {
	...
	Properties     map[string]string `json:"properties,omitempty" example:"water_requirement:medium,climate:temperate"`
}
...
type UpdateCropRequest struct {
	...
	Properties     map[string]string `json:"properties,omitempty" example:"irrigation:required,fertilizer:high"`
...
type CreateCropVarietyRequest struct {
	...
	Properties   map[string]string   `json:"properties,omitempty" example:"disease_resistance:high,recommended_for:punjab_haryana"`
}
...
type UpdateCropVarietyRequest struct {
	...
	YieldPerTree *float64            `json:"yield_per_tree,omitempty" validate:"omitempty,min=0" example:"0"`
	YieldByAge   []YieldByAgeRequest `json:"yield_by_age,omitempty"`
	Properties   map[string]string   `json:"properties,omitempty" example:"drought_tolerance:medium,market_demand:high"`
	IsActive     *bool               `json:"is_active,omitempty" example:"true"`
}

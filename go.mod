module github.com/Kisanlink/farmers-module
...
require (
	github.com/Kisanlink/kisanlink-db v0.0.0-00010101000000-000000000000
...
// Replace with actual kisanlink-db version when available
